    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color(0xFF11A4D4),
      ...
      home: const LearningHubDashboard(),
    );
  }
}

class LearningHubDashboard extends StatefulWidget {
  const LearningHubDashboard({super.key});

  @override
  State<LearningHubDashboard> createState() => _LearningHubDashboardState();
}

class _LearningHubDashboardState extends State<LearningHubDashboard> {
